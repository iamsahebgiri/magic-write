  ...
  return (
    <footer className="space-y-3 py-12">
      <div className="font-medium">
        Made with ❤️ by{' '}
        <a
          href="https://iamsahebgiri.vercel.app"
          target="_blank"
          className="font-semibold decoration-wavy decoration-indigo-500 hover:underline transition underline-offset-2"
        >
          Saheb Giri
        </a>
      </div>
